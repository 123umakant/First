...
public class MemberSubjectsRemoveController extends HttpServlet {
...
public void doPost(HttpServletRequest req, HttpServletResponse res)throws IOException,ServletException
{
	...
	List <Plans> plans = ofy().load().type(Plans.class).filter("expirytimestamp >=", from_time).filter("expirytimestamp <", to_time).list();
